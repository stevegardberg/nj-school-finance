...
def fetch_table(table):
    ...
    # Standardize column names to lowercase automatically
...
# 2. MERGE WITH COLUMN VALIDATION
...
# Merge Mapping (Check if columns exist to prevent KeyError)
if 'ld_display' in df_map.columns:
    df_merged = df_merged.merge(df_map[['cds_code', 'ld_display']], on='cds_code', how='left')
else:
    df_merged['ld_display'] = "Not Listed"

# Merge Metadata (Check if columns exist)
if 'district_type' in df_meta.columns:
